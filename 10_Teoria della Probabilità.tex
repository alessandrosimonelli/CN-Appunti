\section{Teoria della Probabilità}
    \subsection{Introduzione}
        Perché abbiamo bisogno della teoria della probabilità? Prendiamo un sistema di comunicazione:
        \begin{figure}[H]
            \centering
                \begin{tikzpicture}[
                        node distance=2.5cm,
    ...
    \subsection{Modelli probabilistici}
        ...
        \subsubsection{Problemi esempio:}
            \paragraph{Radar Detection Problem:} Nel problema del rilevamento vogliamo analizzare in particolare tre tipi di probabilità:
                \begin{itemize}
                    \item {
                ...
                Ricordiamo che $P[A^c] = 1-P[A]$, nel nostro caso il problema si risolve facilmente applicando il Th della probabilità totale su due set disgiunti 
            ...
            \paragraph{Esempio palline:}
                ...
                \subparagraph{Aggiungiamo due palline da \emph{pippo} in \emph{pluto}:} Cambia il Th della probabilità totale:
                    \begin{itemize}
    ...
    \subsection{Variabili Aleatorie - Random Variables}
        ...
        \subsubsection{Funzioni di Distribuzione - Distribution Functions}
            ...
            \paragraph{Proprietà:}
                ...
                \end{itemize}
        \subsubsection{Funzione Densità di Probabilità - Probability Density Function (pdf)}
        ...
        \subsubsection{Funzione Probabilità di massa - Probability Mass Function (pmf)}
            ...
            \paragraph{Esempio di Bernoulli}
                ...
                \end{itemize}
                Tale variabile aleatoria è chiamata \emph{variabile aleatoria di Bernoulli}:
                \begin{figure}[H]
                    \centering
                    \begin{tikzpicture}
                        \begin{axis}[
        ...
        \subsubsection{Funzione Densità di Probabilità Condizionata - Conditional Probability Density Function}
            ...
            probabilità diventa $f_{X (x)}f_{Y (y)}$, se così fosse le due variabili si dicono \emph{statisticamente indipendenti}\index{Statisticamente Indipendenti}.
        ...
        \subsubsection{Covarianza - Covariance}
            ...
            \end{gather}
            Il \emph{coefficiente di correlazione}\index{Coefficiente di Correlazione} di $X$ e $Y$ è:
            \[
        ...
        \subsubsection{Teorema del Limite Centrale - Central Limit Theorem}\label{Teorema del Limite Centrale - Central Limit Theorem}
            ...
            \]
        \subsubsection{Calcolo probabilità di errore di un sistema} 
            ...
            \begin{itemize}
                \item {$P_r(\hat{S}=1|S=-1)$:
                    ...
                    \end{figure}                    
                    posso basare la decisione di errore se ricevo qualcosa di positivo quando il simbolo inviato è negativo, $P[Y\geq 0|S=-1]$.
                ...
                \item {Calcoliamo ${P_r(\hat{S}=-1|S=1)}$ applicando la formula dell'errore sopra trovata:
                    ...
                    \end{align}
                    sottraggo a $1$ la probabilità per la definizione della $Q_{(x)}$ è l'integrale della zona a dx e a me interessa l'area a sinistra:
                    \begin{figure}[H]
                        \centering
                            \begin{tikzpicture}
                                \begin{axis}[
            ...
            \end{itemize}
            La probabilità totale di errore del sistema è:
            \begin{align}
            ...
            \paragraph{Caso con rumore complesso:} $Y = \sqrt{p}S + n$:
                ...
                \]
                Nel caso del rumore complesso ho solo metà del disturbo dovuto ad esso poiché il simbolo non dipende dalla parte immaginaria.
            \paragraph{Caso con rumore e simboli complessi:} $Y = \sqrt{p}S + n \sim \mathcal{N}(0,\sigma_n^2)$:
                ...
                \end{figure}
                basiamo la decisione del simbolo ricevuto rispetto al quadrante in cui cade, la probabilità di errore del 
